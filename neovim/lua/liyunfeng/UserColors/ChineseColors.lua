...
vim.cmd("highlight ChineseColorMaiMiaoGreenBackground ctermfg=115 guifg=#55bb8a ctermbg=115 guibg=#55bb8a cterm=italic gui=italic")

-- 中国色 海棠红
-- 240,55,82
-- #f03752
vim.cmd("highlight ChineseColorHaiTangRed ctermfg=204 guifg=#f03752 cterm=italic gui=italic")
vim.cmd("highlight ChineseColorHaiTangRedBackground ctermfg=204 guifg=#f03752 ctermbg=204 guibg=#f03752 cterm=italic gui=italic")

-- 中国色 墨紫
-- 49,15,27
-- #310f1b
vim.cmd("highlight ChineseColorMoZi ctermfg=53 guifg=#310f1b cterm=italic gui=italic")
vim.cmd("highlight ChineseColorMoZiBackground ctermfg=53 guifg=#310f1b ctermbg=53 guibg=#310f1b cterm=italic gui=italic")

-- 中国色 品红
-- 239,52,115
-- #ef3473
vim.cmd("highlight ChineseColorPinHong ctermfg=204 guifg=#ef3473 cterm=italic gui=italic")
vim.cmd("highlight ChineseColorPinHongBackground ctermfg=204 guifg=#ef3473 ctermbg=204 guibg=#ef3473 cterm=italic gui=italic")

-- 中国色 品蓝
-- 43,115,175
-- #2b73af
vim.cmd("highlight ChineseColorPinLan ctermfg=67 guifg=#2b73af cterm=italic gui=italic")
vim.cmd("highlight ChineseColorPinLanBackground ctermfg=67 guifg=#2b73af ctermbg=67 guibg=#2b73af cterm=italic gui=italic")

-- 中国色 山梗紫
-- 97,100,159
-- #61649f
vim.cmd("highlight ChineseColorShanGengZi ctermfg=103 guifg=#61649f cterm=italic gui=italic")
vim.cmd("highlight ChineseColorShanGengZiBackground ctermfg=103 guifg=#61649f ctermbg=103 guibg=#61649f cterm=italic gui=italic")

-- 中国色 浪花绿
-- 146,179,165
-- #92b3a5
vim.cmd("highlight ChineseColorLangHuaGreen ctermfg=151 guifg=#92b3a5 cterm=italic gui=italic")
vim.cmd("highlight ChineseColorLangHuaGreenBackground ctermfg=151 guifg=#92b3a5 ctermbg=151 guibg=#92b3a5 cterm=italic gui=italic")
